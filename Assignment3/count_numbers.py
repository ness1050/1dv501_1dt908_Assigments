...
def file_to_int_list(path, separator):
    #It opens and read the file and converts it into int list
    int_list = []
    ...
    return int_list
# by using a set we seperat all duplicates and the counts it 
...
print(f'The amount of different numbers in file A: {count_different(a_list)} The most common number in A is: {common_a[1:]} with {common_a[0]} ocurances')
...
print(f'The most 5 common number in B is: {common_b[1:]} with {common_b[0]} ocurances')
